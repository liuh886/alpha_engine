...
def train_model(
    ...
    try:
        ...
        train_features = dataset.prepare(
            segments="train", col_set="feature", data_key=DataHandler.DK_I
        )
    ...
    print(
        f"PCA Reduced dimensions from {train_features.shape[1]} to {reduced_train_features.shape[1]}"
    )
