...
- AlphaEngine currently runs without authentication by default. If you've enabled auth middleware, check your `ALPHAENGINE_AUTH_SECRET` configuration.
