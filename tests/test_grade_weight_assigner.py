...
class TestGradeAssignment:
    def test_all_grades_assigned(self, assigner: GradeWeightAssigner) -> None:
        ...
        allocation = assigner.compute_allocation(scores, current_date="2024-06-15")
    ...
    def test_small_universe_scales_tiers(self, assigner: GradeWeightAssigner) -> None:
    ...
    def test_empty_scores_returns_empty_allocation(self, assigner: GradeWeightAssigner) -> None:
    ...
    def test_all_nan_scores_returns_empty_allocation(self, assigner: GradeWeightAssigner) -> None:
...
class TestWeightNormalization:
    def test_long_weights_sum_to_long_fraction(self, assigner: GradeWeightAssigner) -> None:
    ...
    def test_short_weights_sum_to_short_fraction(self, assigner: GradeWeightAssigner) -> None:
    ...
    def test_regime_factor_scales_allocation(self, assigner: GradeWeightAssigner) -> None:
    ...
    def test_regime_factor_zero_means_all_cash(self, assigner: GradeWeightAssigner) -> None:
...
class TestPositionCap:
    def test_no_position_exceeds_max_single(self, assigner: GradeWeightAssigner) -> None:
        ...
        max_weight = max(
            list(allocation.long_positions.values()) + list(allocation.short_positions.values()),
            default=0.0,
        )
        assert max_weight <= 0.15 + 1e-6  # tiny epsilon for float

    def test_tight_cap_applied_with_small_step_size(self, assigner: GradeWeightAssigner) -> None:
...
class TestMinStocks:
    ...
    def test_sufficient_stocks_enables_allocation(self, assigner: GradeWeightAssigner) -> None:
