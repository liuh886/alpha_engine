...
export const routes: RouteDefinition[] = [
  ...
  { path: 'models', title: 'Model Evidence', label: 'Models', releaseLevel: 'release', navGroup: 'Evidence', surface: 'artifact', icon: Cpu, component: ModelsPage },
  ...
  { path: 'data', title: 'Data Evidence', label: 'Data', releaseLevel: 'release', navGroup: 'Evidence', surface: 'connected', icon: Database, component: DataPage },
  { path: 'factors', title: 'Factor Evidence', label: 'Factors', releaseLevel: 'release', navGroup: 'Evidence', surface: 'connected', icon: BarChart3, component: FactorPage },
  { path: 'experiments', title: 'Experiment Journal', label: 'Experiments', releaseLevel: 'experimental', navGroup: 'Evidence', surface: 'connected', icon: ClipboardList, component: ExperimentLogPage },
  { path: 'reports', title: 'Reports & Notebooks', label: 'Reports', releaseLevel: 'release', navGroup: 'Evidence', surface: 'connected', icon: ScrollText, component: ReportsPage },
...
export function isRuntimeVisible(route: RouteDefinition): boolean {
  if (runtimeCapabilities.backendApi) return route.surface === 'connected' || route.surface === 'both' || route.surface === 'artifact';
