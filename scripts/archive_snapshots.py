...
def main():
    parser = argparse.ArgumentParser(description="Archive old SQLite data snapshots to Parquet format")
    parser.add_argument("--days-old", type=int, default=30, help="Archive snapshots older than N days")
    parser.add_argument("--dry-run", action="store_true", help="Print what would be archived without actually doing it")
