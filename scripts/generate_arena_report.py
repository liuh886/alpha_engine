...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate an HTML daily Arena report and index it in SQLite.")
    ...
    parser.add_argument("--date", type=str, default="latest", help="YYYY-MM-DD or 'latest' (default).")
