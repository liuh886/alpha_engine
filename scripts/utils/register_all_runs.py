...
def register():
    ...
    for exp_dir in mlruns_dir.iterdir():
        ...
        for run_dir in exp_dir.iterdir():
            if not run_dir.is_dir() or run_dir.name == "artifacts": continue
            
            run_id = run_dir.name
            if run_id in existing_run_ids: continue
                ...
                if meta_path.exists():
                    try:
                        with open(meta_path) as f:
                            ...
                            # Check tags
                            tags = meta.get("tags", {})
                            if "cn" in str(tags).lower(): market = "cn"
                    except: pass
