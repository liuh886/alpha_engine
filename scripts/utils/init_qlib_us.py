...
def main():
    ...
    try:
        GetData().qlib_data(name="qlib_data", region="us", target_dir=str(target_dir), delete_old=True)
        print("Done. Please verify data exists in:", target_dir)
    except Exception as e:
        print(f"Error downloading US data: {e}")
        print("Fallback: You may need to manually download CrowdSource data or similar for US equities.")
