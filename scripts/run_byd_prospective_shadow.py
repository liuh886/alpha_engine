#!/usr/bin/env python3
"""Append new BYD shadow observations without rewriting sealed history."""
...
def _fetch_yahoo(as_of: str) -> tuple[pd.DataFrame, dict[str, Any]]:
    ...
    return out[["date", "open", "high", "low", "close", "volume", "adj_close"]], {
        "provider": "yfinance",
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "status": "prospective_shadow_updated",
                "as_of": as_of,
