...
def main():
    parser = argparse.ArgumentParser(description="Verify reproducibility by comparing two backtest prediction artifacts.")
    ...
    if not p1 or not p2:
        print(f"Error: Could not find pred.pkl for one or both runs ({args.run_id_1}, {args.run_id_2})")
        sys.exit(1)
